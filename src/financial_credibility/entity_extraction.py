...
_ASSET_PATTERNS = [
    ...
    (r"\bFed funds\b|\bfederal funds rate\b", "Federal Funds Rate", "FEDFUNDS", "rates", "interest_rate"),
    (r"\bSOFR\b", "SOFR", "SOFR", "rates", "interest_rate"),
    (r"\b10[- ]year Treasury\b|\b10Y Treasury\b|\bDGS10\b", "10-Year Treasury Yield", "DGS10", "rates", "sovereign_rate"),
    (r"\b2[- ]year Treasury\b|\b2Y Treasury\b|\bDGS2\b", "2-Year Treasury Yield", "DGS2", "rates", "sovereign_rate"),
